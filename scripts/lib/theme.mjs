...
export function renderThemeStyles() {
  return `<style>
  :root {
    /* Marca: azul noche + ámbar */
    --navy: #0f1626; --navy-soft: #182136; --navy-line: #263150;
  ...
  * { box-sizing: border-box; }
  ...
  .logo-mark { width: 30px; height: 30px; border-radius: 8px; background: var(--accent); color: var(--navy); display: flex; align-items: center; justify-content: center; }
  ...
  .btn-ghost.on { background: var(--accent); border-color: var(--accent); color: var(--navy); }
  ...
  .status-pill {
    ...
    color: var(--accent-soft); background: rgba(245,158,11,.10); border: 1px solid rgba(245,158,11,.28);
  ...
  .btn-primary { background: var(--accent); color: var(--navy); box-shadow: 0 6px 20px rgba(245,158,11,.25); }
  ...
  .cookie-banner button { font-family: inherit; font-size: 13px; font-weight: 600; color: var(--navy); background: var(--accent); border: none; border-radius: 8px; padding: 8px 14px; cursor: pointer; }
